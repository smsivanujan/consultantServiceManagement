    ...
    <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-2 fw-semibold">76</h3>
                        <p class="text-muted fs-13 mb-0">Total Appointments</p>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <p class="text-muted fs-13 mb-0">Approved Appointments</p>
                    </div>
                    <div class="col col-auto top-icn dash">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <p class="text-muted fs-13 mb-0">Canceled Appointments</p>
                    </div>
                    <div class="col col-auto top-icn dash">
    ...
    <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-2 fw-semibold">46</h3>
                        <p class="text-muted fs-13 mb-0">Pending Appointments</p>
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-2 fw-semibold">76</h3>
                        <p class="text-muted fs-13 mb-0">Total Jobseekers</p>
                    </div>
                    <div class="col col-auto top-icn dash">
                        <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
    ...
    <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3 class="mb-2 fw-semibold">18</h3>
                        <p class="text-muted fs-13 mb-0">Total Consultant</p>
                    </div>
                    <div class="col col-auto top-icn dash">
                        <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
