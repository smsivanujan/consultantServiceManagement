                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->is_active }}</td>
                                <td>
                                    <a class="btn btn-blue edit" title="Edit" data-id="{{ $row->id }}" data-role_name="{{ $row->role_name }}" data-is_active="{{ $row->is_active }}">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createFormModal">Create Role</h5>
